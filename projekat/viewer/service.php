      ...
      <section id="services" class="section pad-bot5 bg-white">
        <div class="container">
          ...
          <form method="GET" action="">
            <p>Format ulaznih podataka: <select name="ulaz">
                <option value="xml">XML</option>
                <option value="json">JSON</option>
              </select></p>
            <p>Poredak sortiranja: <select name="sort">
                <option value="ASC">Rastuci</option>
                <option value="DESC">Opadajuci</option>
              </select></p>
            <p>Format izlaznih podataka: <select name="izlaz">
                <option value="xml">XML</option>
                <option value="json">JSON</option>
              </select></p>
          ...
          <?php if (isset($_GET['ulaz']) && isset($_GET['sort']) && isset($_GET['izlaz'])) { ?>
            ...
            switch ($_GET['izlaz']) {
              case "xml":
                ...
                $proizvodi = new SimpleXMLElement($curl_odgovor, 0, false);
